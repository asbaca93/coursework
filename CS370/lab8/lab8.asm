;modified by andrew baca 4/15/18
...
main:
    ...
    ;END OF READNUM
    ;START while loop som of squares STMT
...
_L3:	 			; WHILE TOP target
	...
	mov rbx, rsi		; RHS expresion a number 100 100 100 100 100     CHANGE BOUNDS TO USER INPUT
	...
	JE  _L4		;WHILE branch out                                             change label
	mov rax, 16		;get Identifier offset
	add rax, rsp		; Add the SP to have direct reference to memory 
	mov rax, [rax]		;LHS expression is identifier
	...
	mov [rax], rdx		; ASSIGN final store 
	JMP _L3		;WHILE Jump back                      changed label name
_L4:	 			; End of WHILE                changed label name
